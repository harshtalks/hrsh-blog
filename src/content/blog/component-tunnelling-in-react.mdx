...
## Tunnelling is fun
We will write a very simple and intuitive function for component tunnelling system, in which one component can be declared at one place and the result will appear somewhere else in the DOM. This is a fun exercise to understand React rendering.
